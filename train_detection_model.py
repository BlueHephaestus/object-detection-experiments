...
def model1(x,y,input_shape):

    print "Training model 1 - mk5 without 2nd to last conv correction (we had it as 64 instead of 128 originally, that is what this one is) "
    ...
    #input 128,128,3
    model.add(Conv2D(32, (7, 7), strides=(1, 1), padding="same", input_shape=input_shape, data_format="channels_last", activation="relu", kernel_regularizer=l2(regularization_rate)))
    #input 128,128,32
    model.add(MaxPooling2D(data_format="channels_last"))

    #input 64,64,32
    model.add(Conv2D(32, (7, 7), strides=(1, 1), padding="same", data_format="channels_last", activation="relu", kernel_regularizer=l2(regularization_rate)))
    #input 64,64,32
    model.add(MaxPooling2D(data_format="channels_last"))
...
def model2(x,y,input_shape):

    print "Training model 2 - mk6 without 2nd to last conv correction (we had it as 64 instead of 128 originally, that is what this one is) "
...
def model3(x,y,input_shape):

    print "Training model 3 - mk5 with SGD instead of Adam and mistake of earlier runs"
...
def model4(x,y,input_shape):

    print "Training model 4 - mk6 with SGD instead of Adam and mistake of earlier runs"
...
def model5(x,y,input_shape):

    print "Training model 5 - mk5 with SGD instead of Adam and original design"
...
def model6(x,y,input_shape):

    print "Training model 6 - mk6 with SGD instead of Adam and original design"
