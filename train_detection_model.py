...
def get_new_balanced_batch(x, y, sample_n, positive_n):
    ...
    while True:
        ...
        """
        x_batch[:(batch_size/2)] = x[:(batch_size/2)]
        y_batch[:(batch_size/2)] = y[:(batch_size/2)]
...
train_model("hog_samples.h5", "phase2_smaller_augmented_samples_type1_detection_model")
